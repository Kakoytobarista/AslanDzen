"""
Django's settings for yatube project.
...
SECRET_KEY = os.getenv('SECRET_KEY', default='s602!acnd(oi7$*!h8=_#796#yca5vt+_-dgr(i26u%docfwm3')
...
MIDDLEWARE = [
    ...
    'core.middleware.middleware.FilterIPMiddleware'
]
